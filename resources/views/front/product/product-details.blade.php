...
@section('body')
    ...
    <div class="men">
        <div class="container">
            ...
            <div class="toogle">
                <h2>Product Short Details</h2>
                <p class="m_text2">{{$product->Short_description}}</p>
            </div>
            <div class="toogle">
                <h2>More Long Information</h2>
                <p class="m_text2">{{$product->long_description}}</p>
            </div>
            <h4 class="head_single">Related Products</h4>
            <div class="span_3">

                @foreach($latestProductcategories as $latestProductcategory)

                <div class="col-sm-3 grid_1">

                    <a href="{{url('/product-details/'.$product->id)}}">
                        <img src="{{asset($latestProductcategory->product_image)}}" class="img-responsive" alt=""/>
                        <h3>{{$latestProductcategory->product_name}}</h3>
                        <p>Duis autem vel eum iriure</p>
                        <h4>{{$latestProductcategory->product_price}}</h4>
                    </a>
